...
#ifndef GOOGLE_PROTOBUF_INCLUDED_rpc_5fecho_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_rpc_5fecho_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_rpc_5fecho_2eproto
...
struct TableStruct_rpc_5fecho_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpc_5fecho_2eproto;
namespace rpc_test {
class EchoRequest;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::rpc_test::EchoRequest* Arena::CreateMaybeMessage<::rpc_test::EchoRequest>(Arena*);
template<> ::rpc_test::EchoResponse* Arena::CreateMaybeMessage<::rpc_test::EchoResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rpc_test {
...
class EchoRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rpc_test.EchoRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpc_test.EchoRequest)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_rpc_5fecho_2eproto;
};
// -------------------------------------------------------------------

class EchoResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rpc_test.EchoResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpc_test.EchoResponse)
 private:
  class _Internal;
...
inline const std::string& EchoRequest::payload() const {
  // @@protoc_insertion_point(field_get:rpc_test.EchoRequest.payload)
...
void EchoRequest::set_payload(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.payload_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc_test.EchoRequest.payload)
}
inline std::string* EchoRequest::mutable_payload() {
  std::string* _s = _internal_mutable_payload();
  // @@protoc_insertion_point(field_mutable:rpc_test.EchoRequest.payload)
  return _s;
}
...
inline std::string* EchoRequest::release_payload() {
  // @@protoc_insertion_point(field_release:rpc_test.EchoRequest.payload)
...
inline void EchoRequest::set_allocated_payload(std::string* payload) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rpc_test.EchoRequest.payload)
}
...
inline const std::string& EchoResponse::payload() const {
  // @@protoc_insertion_point(field_get:rpc_test.EchoResponse.payload)
  return _internal_payload();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void EchoResponse::set_payload(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.payload_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc_test.EchoResponse.payload)
}
inline std::string* EchoResponse::mutable_payload() {
  std::string* _s = _internal_mutable_payload();
  // @@protoc_insertion_point(field_mutable:rpc_test.EchoResponse.payload)
  return _s;
}
...
inline std::string* EchoResponse::release_payload() {
  // @@protoc_insertion_point(field_release:rpc_test.EchoResponse.payload)
  return _impl_.payload_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:rpc_test.EchoResponse.payload)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_rpc_5fecho_2eproto
